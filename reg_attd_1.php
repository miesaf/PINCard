		  	...
		  	<div class="row">
		  		<div class="col-md-10">
					<div class="content-box-header">
						<div class="panel-title">Senarai Program (Daftar Kehadiran Pelajar)</div>
					</div>
					<div class="content-box-large box-with-header">
						<table>
						<form id="sel_org" action="reg_attd_1.php" method="GET">
							<tbody>
								<tr>
						...
						<?php
                            ...
                            {            
                                ...
                                while ($row = mysql_fetch_array($result))
                                {
                                    ...
                                    echo "<td>
											<a target='_blank' href='reg_attd_2.php?EVN=$EVN_ID'>$EVN_NAME</a>
										</td>
