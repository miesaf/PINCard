...
<html>
  ...
  <?php
		...
		{
			// delete the entry
			$result = mysql_query("DELETE FROM STUDENT"); 
			...
			if ($result)
			{
			   echo '<html>
						<head>
							<script>
								window.alert("Pangkalan data pelajar berjaya di kosongkan!");
							</script>
			...
			else
			{
				...
				echo '<html>
						<head>
							<script>
								window.alert("Pangkalan data pelajar gagal di kosongkan!");
								window.history.go(-1);
							</script>
						</head>
					</html>';
  ...
  <body>
			...
			<div class="row">
		  		<div class="col-md-10">
		  			<div class="content-box-header">
						<div class="panel-title">Reset Semula Pangkalan Data Pelajar</div>
					</div>
					<div class="content-box-large box-with-header">
						<fieldset>
							<h3>AMARAN!</h3>
							<h4>1) Tindakan ini akan memadam seluruh rekod pelajar yang wujud didalam pangkalan data!</h4>
	...
	<script language="JavaScript">
		function confirmDel()
		{
			var del = confirm("Tindakan ini akan memadam seluruh rekod pelajar yang wujud didalam pangkalan data!");
			if (del == true)
			{
				var del2 = confirm("Adakah anda pasti untuk mengosongkan pangkalan data pelajar?");
				if (del2 == true)
				{
					window.location.assign("res_stud.php?DEL=Y");
				} else 
				{
					alert("Tindakan mengosongkan pangkalan data pelajar dibatalkan.");
				}
			}
