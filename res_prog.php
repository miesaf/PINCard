...
<html>
  ...
  <?php
		...
		{
			// delete the entry
			$result = mysql_query("DELETE FROM EVENT"); 
			...
			if ($result)
			{
			   echo '<html>
						<head>
							<script>
								window.alert("Pangkalan data program pelajar berjaya di kosongkan!");
							</script>
			...
			else
			{
				...
				echo '<html>
						<head>
							<script>
								window.alert("Pangkalan data program pelajar gagal di kosongkan!");
								window.history.go(-1);
							</script>
						</head>
					</html>';
  ...
  <body>
			...
			<div class="row">
		  		<div class="col-md-10">
		  			<div class="content-box-header">
						<div class="panel-title">Reset Semula Pangkalan Data Program Pelajar</div>
					</div>
					<div class="content-box-large box-with-header">
						<fieldset>
							<h3>AMARAN!</h3>
							<h4>1) Tindakan ini akan memadam seluruh rekod program pelajar yang wujud didalam pangkalan data!</h4>
							<h4>2) Tindakan ini adalah bersifat KEKAL dan tidak boleh diundur semula!</h4>
							<h4>3) Sila reset semula pangkalan data Kehadiran terlebih dahulu sebelum reset pangkalan data ini.</h4>
						</fieldset>
						<div>
	...
	<script language="JavaScript">
		function confirmDel()
		{
			var del = confirm("Tindakan ini akan memadam seluruh rekod program pelajar yang wujud didalam pangkalan data!");
			if (del == true)
			{
				var del2 = confirm("Adakah anda pasti untuk mengosongkan pangkalan data program pelajar?");
				if (del2 == true)
				{
					window.location.assign("res_prog.php?DEL=Y");
				} else 
				{
					alert("Tindakan mengosongkan pangkalan data program pelajar dibatalkan.");
				}
			}
