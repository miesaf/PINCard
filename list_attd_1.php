		  	...
		  	<div class="row">
		  		<div class="col-md-10">
					<div class="content-box-header">
						<div class="panel-title">Senarai Program (Senarai Kehadiran Pelajar)</div>
					</div>
					<div class="content-box-large box-with-header">
						<table>
						<form id="sel_org" action="list_attd_1.php" method="GET">
							<tbody>
								<tr>
									<td align="right" valign="center">Sila pilih penganjur :</td>
									<td>
										<select class="form-control input-sm" name="SEL_ORG">
											<?php
											$SEL	= null;
											$S_ALL	= null;
											if(isset($_GET['SEL_ORG']))
						...
						<?php
                            ...
                            {            
                                ...
                                while ($row = mysql_fetch_array($result))
                                {
                                    ...
                                    echo "<td>
											<a target='_blank' href='list_attd_2.php?EVN=$EVN_ID'>$EVN_NAME</a>
										</td>
